...
charities = [
  ...
  },
  {
    ...
    description: "Works to improve the lives of marginalized communities through education, health,
  ...
  },
  {
    ...
    description: "Provides education and vocational training to young women, with a focus on empowering
  ...
  },
  {
    ...
    description: "Collects and distributes surplus food to those in need, and works
  ...
  },
  {
    ...
    description: "Works to improve access to safe water and sanitation in rural communities, with a focus on promoting
  ...
  },
  {
    ...
    description: "Provides humanitarian assistance and support to refugees and migrants, and works
  ...
  },
  {
    ...
    description: "Works to improve living conditions and economic opportunities in urban and rural communities, through
  ...
  },
  {
    ...
    description: "Works to provide education and healthcare services to children affected by HIV/AIDS, and supports
    community-based initiatives to promote social inclusion.",
    cause: "Health",
  ...
  },
  {
    ...
    address: "Lahore, Pakistan",
    description: "Animal Welfare Association is an organization in Pakistan that works to promote the welfare and
    rights of animals, including pets. They provide veterinary care, food, and shelter to animals in need, and also work
  ...
  },
  {
    ...
    description: "The Society for the Prevention of Cruelty to Animals is an animal welfare organization
    in India that works to protect and care for animals, including pets. They rescue and rehabilitate injured and
    sick animals, and also work to educate the public about animal welfare issues.",
    cause: "Animal Welfare",
  ...
  },
  {
    ...
    address: "Nairobi, Kenya",
    description: "The African Wildlife Foundation is an organization in Kenya that works to protect and conserve
    wildlife in Africa, including endangered species. They also work to promote sustainable development in
    local communities and educate the public about conservation issues.",
    cause: "Animal Welfare",
